...
class SyntaxAnalyzer:
    def __init__(self, table: SLRTable):
        ...
        self.cfg: List[List[str]] = [
            ...
            ['MATCHED', 'STMT'],
            ['UNMATCHED', 'STMT'],
            ['if lparen COND rparen lbrace BLOCK rbrace else lbrace BLOCK rbrace', 'MATCHED'],
            ['while lparen COND rparen lbrace BLOCK rbrace', 'MATCHED'],
            ['if lparen COND rparen lbrace BLOCK rbrace', 'UNMATCHED'],
            ['if lparen COND rparen lbrace BLOCK rbrace else UNMATCHED', 'UNMATCHED'],
            ['COND comp SIMPLECOND', 'COND'],
            ['SIMPLECOND', 'COND'],
            ['boolstr', 'SIMPLECOND'],
